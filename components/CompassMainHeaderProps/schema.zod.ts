// Auto-generated Zod schema for CompassMainHeaderProps
import { z } from 'zod'

export const CompassMainHeaderPropsSchema = z.object({
...
export type CompassMainHeaderPropsProps = z.infer<typeof CompassMainHeaderPropsSchema>
