// Auto-generated Zod schema for EmptyStateProps
import { z } from 'zod'
...
export const EmptyStatePropsSchema = z.object({
  ...
  variant: z.enum(['xs', 'sm', 'lg', 'xl', 'full']).optional()
})

export type EmptyStatePropsProps = z.infer<typeof EmptyStatePropsSchema>
