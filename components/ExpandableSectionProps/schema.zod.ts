// Auto-generated Zod schema for ExpandableSectionProps
import { z } from 'zod'
...
variant, the expandable content will be truncated after 3 lines by default. */
  variant: z.enum(['default', 'truncate']).optional()
})

export type ExpandableSectionPropsProps = z.infer<typeof ExpandableSectionPropsSchema>
