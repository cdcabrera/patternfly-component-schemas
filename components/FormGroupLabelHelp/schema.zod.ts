// Auto-generated Zod schema for FormGroupLabelHelp
import { z } from 'zod'

export const FormGroupLabelHelpSchema = z.object({
...
export type FormGroupLabelHelpProps = z.infer<typeof FormGroupLabelHelpSchema>
