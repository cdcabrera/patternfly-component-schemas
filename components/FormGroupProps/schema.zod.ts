// Auto-generated Zod schema for FormGroupProps
import { z } from 'zod'

export const FormGroupPropsSchema = z.object({
...
If only one field is included, its ID attribute and this prop must be the same. */
  ...
  hasNoPaddingTop: z.boolean().optional(),
...
export type FormGroupPropsProps = z.infer<typeof FormGroupPropsSchema>
