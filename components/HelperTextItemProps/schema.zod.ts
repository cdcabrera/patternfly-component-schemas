// Auto-generated Zod schema for HelperTextItemProps
import { z } from 'zod'

export const HelperTextItemPropsSchema = z.object({
  ...
  component: z.enum(['div', 'li']).optional(),
...
with the icon prop. */
  variant: z.enum(['default', 'indeterminate', 'warning', 'success', 'error']).optional()
})

export type HelperTextItemPropsProps = z.infer<typeof HelperTextItemPropsSchema>
