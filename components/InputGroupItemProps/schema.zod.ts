// Auto-generated Zod schema for InputGroupItemProps
import { z } from 'zod'

export const InputGroupItemPropsSchema = z.object({
...
export type InputGroupItemPropsProps = z.infer<typeof InputGroupItemPropsSchema>
