// Auto-generated Zod schema for ModalHeaderProps
import { z } from 'zod'

export const ModalHeaderPropsSchema = z.object({
...
export type ModalHeaderPropsProps = z.infer<typeof ModalHeaderPropsSchema>
