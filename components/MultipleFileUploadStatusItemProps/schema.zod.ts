// Auto-generated Zod schema for MultipleFileUploadStatusItemProps
import { z } from 'zod'

export const MultipleFileUploadStatusItemPropsSchema = z.object({
  ...
  onReadFail: z.custom<(error: DOMException, onReadFail: File) => void>().optional(),
  /** A callback for when a selected file finishes loading */
  onReadFinished: z.custom<(fileHandle: File) => void>().optional(),
  /** A callback for when a selected file starts loading */
  onReadStarted: z.custom<(fileHandle: File) => void>().optional(),
  /** A callback for when the FileReader successfully reads the file */
  onReadSuccess: z.custom<(data: string, file: File) => void>().optional(),
...
export type MultipleFileUploadStatusItemPropsProps = z.infer<typeof MultipleFileUploadStatusItemPropsSchema>
