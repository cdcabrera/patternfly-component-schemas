// Auto-generated Zod schema for PageProps
import { z } from 'zod'
...
export const PagePropsSchema = z.object({
  ...
  defaultManagedSidebarIsOpen: z.boolean().optional(),
...
https://github.com/patternfly/patternfly-react/blob/main/packages/react-core/src/helpers/util.ts */
  getBreakpoint: z.enum(['sm', 'md', 'lg', 'xl', '2xl']).optional(),
  /** The page resize observer uses the breakpoints returned from this function when adding the pf-m-breakpoint-[default|sm|md|lg|xl|2xl] class
...
https://github.com/patternfly/patternfly-react/blob/main/packages/react-core/src/helpers/util.ts */
  getVerticalBreakpoint: z.enum(['sm', 'md', 'lg', 'xl', '2xl']).optional(),
  ...
  isBreadcrumbWidthLimited: z.boolean().optional(),
...
the sidebar component or add a callback onSidebarToggle function into the Masthead component */
  ...
  isNotificationDrawerExpanded: z.boolean().optional(),
  ...
  onNotificationDrawerExpand: z.any().optional(),
...
export type PagePropsProps = z.infer<typeof PagePropsSchema>
