// Auto-generated Zod schema for PopoverHeaderProps
import { z } from 'zod'

export const PopoverHeaderPropsSchema = z.object({
  ...
  titleHeadingLevel: z.enum(['h1', 'h2', 'h3', 'h4', 'h5', 'h6']).optional()
})

export type PopoverHeaderPropsProps = z.infer<typeof PopoverHeaderPropsSchema>
