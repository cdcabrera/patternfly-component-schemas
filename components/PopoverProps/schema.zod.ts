...
footerContent={hide => <Button onClick={() => hide()}>Close</Button>} */
  ...
  hasAutoWidth: z.boolean().optional(),
...
export type PopoverPropsProps = z.infer<typeof PopoverPropsSchema>
