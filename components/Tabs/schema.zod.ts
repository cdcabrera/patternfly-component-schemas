...
export const TabsSchema = z.object({
  ...
  activeKey: z.any().optional().default(0),
  ...
  hasNoBorderBottom: z.boolean().optional().default(false),
  ...
  isSubtab: z.boolean().optional().default(false),
  ...
  leftScrollAriaLabel: z.string().optional().default('Scroll left'),
  ...
  unmountOnExit: z.boolean().optional().default(false),
