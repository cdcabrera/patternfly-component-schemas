...
export const ToolbarSchema = z.object({
  ...
  /** Flag indicating the toolbar should have sticky positioning to the top of its container */
  isStickyBase: z.boolean().optional(),
  /** Flag indicating the toolbar should have stuck styling, when the toolbar is not at the top of the scroll container */
  isStickyStuck: z.boolean().optional(),
  /** Flag indicating the toolbar has a vertical orientation */
