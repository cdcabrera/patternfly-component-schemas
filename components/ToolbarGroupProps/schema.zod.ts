// Auto-generated Zod schema for ToolbarGroupProps
import { z } from 'zod'

export const ToolbarGroupPropsSchema = z.object({
...
export type ToolbarGroupPropsProps = z.infer<typeof ToolbarGroupPropsSchema>
