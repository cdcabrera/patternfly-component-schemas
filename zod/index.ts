...
export * from '../components/GridProps/schema.zod.js'
...
export * from '../components/WizardToggle/schema.zod.js'
export * from '../components/WizardToggleProps/schema.zod.js'
export * from '../components/WizardStep/schema.zod.js'
export * from '../components/WizardStepProps/schema.zod.js'
export * from '../components/WizardNavItem/schema.zod.js'
export * from '../components/WizardNavItemProps/schema.zod.js'
export * from '../components/WizardNavInternal/schema.zod.js'
export * from '../components/WizardNav/schema.zod.js'
export * from '../components/WizardNavProps/schema.zod.js'
export * from '../components/WizardHeader/schema.zod.js'
export * from '../components/WizardFooterProps/schema.zod.js'
export * from '../components/WizardFooterWrapperProps/schema.zod.js'
export * from '../components/WizardContextProps/schema.zod.js'
export * from '../components/WizardContextProviderProps/schema.zod.js'
export * from '../components/WizardBody/schema.zod.js'
export * from '../components/WizardBodyProps/schema.zod.js'
export * from '../components/Wizard/schema.zod.js'
export * from '../components/WizardProps/schema.zod.js'
export * from '../components/Truncate/schema.zod.js'
export * from '../components/TruncateProps/schema.zod.js'
export * from '../components/TreeViewSearch/schema.zod.js'
export * from '../components/TreeViewSearchProps/schema.zod.js'
export * from '../components/TreeViewRoot/schema.zod.js'
export * from '../components/TreeViewListItemBase/schema.zod.js'
export * from '../components/TreeViewCheckProps/schema.zod.js'
export * from '../components/TreeViewList/schema.zod.js'
export * from '../components/TreeViewListProps/schema.zod.js'
...
export * from '../components/TooltipProps/schema.zod.js'
export * from '../components/ToolbarContextProps/schema.zod.js'
export * from '../components/ToolbarContentContextProps/schema.zod.js'
export * from '../components/ToolbarToggleGroup/schema.zod.js'
export * from '../components/ToolbarToggleGroupProps/schema.zod.js'
export * from '../components/ToolbarLabelGroupContent/schema.zod.js'
export * from '../components/ToolbarItem/schema.zod.js'
export * from '../components/ToolbarItemProps/schema.zod.js'
export * from '../components/ToolbarGroup/schema.zod.js'
export * from '../components/ToolbarGroupProps/schema.zod.js'
export * from '../components/ToolbarFilter/schema.zod.js'
export * from '../components/ToolbarLabelGroup/schema.zod.js'
export * from '../components/ToolbarLabel/schema.zod.js'
export * from '../components/ToolbarFilterProps/schema.zod.js'
export * from '../components/ToolbarFilterState/schema.zod.js'
export * from '../components/ToolbarExpandableContent/schema.zod.js'
export * from '../components/ToolbarContent/schema.zod.js'
export * from '../components/ToolbarContentProps/schema.zod.js'
export * from '../components/Toolbar/schema.zod.js'
...
export * from '../components/TimestampTooltip/schema.zod.js'
export * from '../components/TimePicker/schema.zod.js'
export * from '../components/TimePickerProps/schema.zod.js'
export * from '../components/TimePickerState/schema.zod.js'
export * from '../components/TextInputGroupMain/schema.zod.js'
export * from '../components/TextInputGroupMainProps/schema.zod.js'
export * from '../components/TextInputGroupIcon/schema.zod.js'
export * from '../components/TextInputGroup/schema.zod.js'
...
export * from '../components/HorizontalOverflowObject/schema.zod.js'
export * from '../components/TabsProps/schema.zod.js'
export * from '../components/TabsState/schema.zod.js'
export * from '../components/TabContentBody/schema.zod.js'
export * from '../components/TabContent/schema.zod.js'
export * from '../components/TabContentProps/schema.zod.js'
export * from '../components/TabButton/schema.zod.js'
export * from '../components/TabButtonProps/schema.zod.js'
export * from '../components/TabAction/schema.zod.js'
export * from '../components/TabActionProps/schema.zod.js'
export * from '../components/Tab/schema.zod.js'
export * from '../components/TabProps/schema.zod.js'
export * from '../components/OverflowTab/schema.zod.js'
export * from '../components/Switch/schema.zod.js'
...
export * from '../components/SimpleListProps/schema.zod.js'
export * from '../components/SimpleListState/schema.zod.js'
export * from '../components/SimpleListContextProps/schema.zod.js'
export * from '../components/SidebarPanel/schema.zod.js'
...
export * from '../components/ProgressStepperProps/schema.zod.js'
export * from '../components/ProgressStep/schema.zod.js'
export * from '../components/ProgressStepProps/schema.zod.js'
export * from '../components/ProgressContainer/schema.zod.js'
export * from '../components/ProgressContainerProps/schema.zod.js'
export * from '../components/ProgressBar/schema.zod.js'
...
export * from '../components/PaginationNavigation/schema.zod.js'
export * from '../components/PaginationNavigationProps/schema.zod.js'
export * from '../components/PaginationNavigationState/schema.zod.js'
export * from '../components/Pagination/schema.zod.js'
...
export * from '../components/PageSidebar/schema.zod.js'
export * from '../components/PageSidebarContextProps/schema.zod.js'
export * from '../components/PageSection/schema.zod.js'
export * from '../components/PageSectionProps/schema.zod.js'
export * from '../components/PageGroup/schema.zod.js'
export * from '../components/PageGroupProps/schema.zod.js'
export * from '../components/PageContextProps/schema.zod.js'
export * from '../components/PageBreadcrumb/schema.zod.js'
...
export * from '../components/NavItemProps/schema.zod.js'
export * from '../components/NavGroup/schema.zod.js'
export * from '../components/NavExpandable/schema.zod.js'
export * from '../components/NavExpandableProps/schema.zod.js'
export * from '../components/NavExpandableState/schema.zod.js'
...
export * from '../components/ModalBoxTitle/schema.zod.js'
export * from '../components/ModalBoxCloseButton/schema.zod.js'
export * from '../components/ModalBoxCloseButtonProps/schema.zod.js'
export * from '../components/ModalBox/schema.zod.js'
export * from '../components/ModalBoxProps/schema.zod.js'
export * from '../components/ModalBody/schema.zod.js'
...
export * from '../components/LoginHeader/schema.zod.js'
...
export * from '../components/FormGroupLabelHelpProps/schema.zod.js'
export * from '../components/FormGroup/schema.zod.js'
export * from '../components/FormFieldGroupToggle/schema.zod.js'
export * from '../components/FormFieldGroupToggleProps/schema.zod.js'
export * from '../components/FormFieldGroupHeader/schema.zod.js'
export * from '../components/FormFieldGroupHeaderTitleTextObject/schema.zod.js'
export * from '../components/FormFieldGroupExpandable/schema.zod.js'
export * from '../components/FormFieldGroup/schema.zod.js'
export * from '../components/FormContextProps/schema.zod.js'
...
export * from '../components/DualListSelectorTreeItemData/schema.zod.js'
export * from '../components/DualListSelectorTreeProps/schema.zod.js'
export * from '../components/DualListSelectorPane/schema.zod.js'
export * from '../components/DualListSelectorListWrapperProps/schema.zod.js'
export * from '../components/DualListSelectorListItemProps/schema.zod.js'
export * from '../components/DualListSelectorListProps/schema.zod.js'
...
export * from '../components/DrawerPanelContentProps/schema.zod.js'
export * from '../components/DrawerPanelBody/schema.zod.js'
export * from '../components/DrawerContent/schema.zod.js'
export * from '../components/DrawerCloseButton/schema.zod.js'
...
export * from '../components/DataListItemRow/schema.zod.js'
export * from '../components/DataListItemCells/schema.zod.js'
export * from '../components/DataListItem/schema.zod.js'
export * from '../components/DataListItemProps/schema.zod.js'
export * from '../components/DataListItemChildProps/schema.zod.js'
export * from '../components/DataListDragButton/schema.zod.js'
export * from '../components/DataListContent/schema.zod.js'
export * from '../components/DataListContentProps/schema.zod.js'
export * from '../components/DataListCheck/schema.zod.js'
export * from '../components/DataListCheckProps/schema.zod.js'
export * from '../components/DataListCell/schema.zod.js'
export * from '../components/DataListAction/schema.zod.js'
...
export * from '../components/ClipboardCopyButtonProps/schema.zod.js'
...
export * from '../components/CardHeaderSelectableActionsObject/schema.zod.js'
export * from '../components/CardBody/schema.zod.js'
export * from '../components/CardBodyProps/schema.zod.js'
export * from '../components/CardActions/schema.zod.js'
...
export * from '../components/AccordionProps/schema.zod.js'
export * from '../components/AboutModalBoxHeader/schema.zod.js'
export * from '../components/AboutModalBoxContent/schema.zod.js'
export * from '../components/AboutModalBoxCloseButton/schema.zod.js'
export * from '../components/AboutModalBoxCloseButtonProps/schema.zod.js'
...
export * from '../components/WizardNavItemProps-deprecated/schema.zod.js'
export * from '../components/WizardNav-deprecated/schema.zod.js'
export * from '../components/WizardNavProps-deprecated/schema.zod.js'
export * from '../components/WizardHeader-deprecated/schema.zod.js'
export * from '../components/WizardFooterInternal-deprecated/schema.zod.js'
export * from '../components/WizardFooter-deprecated/schema.zod.js'
export * from '../components/WizardDrawerWrapperProps-deprecated/schema.zod.js'
export * from '../components/WizardBody-deprecated/schema.zod.js'
export * from '../components/WizardBodyProps-deprecated/schema.zod.js'
export * from '../components/Wizard-deprecated/schema.zod.js'
...
export * from '../components/DroppableItem-deprecated/schema.zod.js'
export * from '../components/DragDrop-deprecated/schema.zod.js'
export * from '../components/DraggableItemPosition-deprecated/schema.zod.js'
export * from '../components/ChipGroup-deprecated/schema.zod.js'
export * from '../components/ChipGroupProps-deprecated/schema.zod.js'
export * from '../components/Chip-deprecated/schema.zod.js'
export * from '../components/ChipProps-deprecated/schema.zod.js'
...
export function getComponentSchema(componentName: string) {
  switch (componentName) {
    ...
    case 'GridProps': return import('../components/GridProps/schema.zod.js').then(m => m.GridPropsSchema);
    ...
    case 'WizardToggle': return import('../components/WizardToggle/schema.zod.js').then(m => m.WizardToggleSchema);
    case 'WizardToggleProps': return import('../components/WizardToggleProps/schema.zod.js').then(m => m.WizardTogglePropsSchema);
    case 'WizardStep': return import('../components/WizardStep/schema.zod.js').then(m => m.WizardStepSchema);
    case 'WizardStepProps': return import('../components/WizardStepProps/schema.zod.js').then(m => m.WizardStepPropsSchema);
    case 'WizardNavItem': return import('../components/WizardNavItem/schema.zod.js').then(m => m.WizardNavItemSchema);
    case 'WizardNavItemProps': return import('../components/WizardNavItemProps/schema.zod.js').then(m => m.WizardNavItemPropsSchema);
    case 'WizardNavInternal': return import('../components/WizardNavInternal/schema.zod.js').then(m => m.WizardNavInternalSchema);
    case 'WizardNav': return import('../components/WizardNav/schema.zod.js').then(m => m.WizardNavSchema);
    case 'WizardNavProps': return import('../components/WizardNavProps/schema.zod.js').then(m => m.WizardNavPropsSchema);
    case 'WizardHeader': return import('../components/WizardHeader/schema.zod.js').then(m => m.WizardHeaderSchema);
    case 'WizardFooterProps': return import('../components/WizardFooterProps/schema.zod.js').then(m => m.WizardFooterPropsSchema);
    case 'WizardFooterWrapperProps': return import('../components/WizardFooterWrapperProps/schema.zod.js').then(m => m.WizardFooterWrapperPropsSchema);
    case 'WizardContextProps': return import('../components/WizardContextProps/schema.zod.js').then(m => m.WizardContextPropsSchema);
    case 'WizardContextProviderProps': return import('../components/WizardContextProviderProps/schema.zod.js').then(m => m.WizardContextProviderPropsSchema);
    case 'WizardBody': return import('../components/WizardBody/schema.zod.js').then(m => m.WizardBodySchema);
    case 'WizardBodyProps': return import('../components/WizardBodyProps/schema.zod.js').then(m => m.WizardBodyPropsSchema);
    case 'Wizard': return import('../components/Wizard/schema.zod.js').then(m => m.WizardSchema);
    case 'WizardProps': return import('../components/WizardProps/schema.zod.js').then(m => m.WizardPropsSchema);
    case 'Truncate': return import('../components/Truncate/schema.zod.js').then(m => m.TruncateSchema);
    case 'TruncateProps': return import('../components/TruncateProps/schema.zod.js').then(m => m.TruncatePropsSchema);
    case 'TreeViewSearch': return import('../components/TreeViewSearch/schema.zod.js').then(m => m.TreeViewSearchSchema);
    case 'TreeViewSearchProps': return import('../components/TreeViewSearchProps/schema.zod.js').then(m => m.TreeViewSearchPropsSchema);
    case 'TreeViewRoot': return import('../components/TreeViewRoot/schema.zod.js').then(m => m.TreeViewRootSchema);
    case 'TreeViewListItemBase': return import('../components/TreeViewListItemBase/schema.zod.js').then(m => m.TreeViewListItemBaseSchema);
    case 'TreeViewCheckProps': return import('../components/TreeViewCheckProps/schema.zod.js').then(m => m.TreeViewCheckPropsSchema);
    case 'TreeViewList': return import('../components/TreeViewList/schema.zod.js').then(m => m.TreeViewListSchema);
    case 'TreeViewListProps': return import('../components/TreeViewListProps/schema.zod.js').then(m => m.TreeViewListPropsSchema);
    ...
    case 'TooltipProps': return import('../components/TooltipProps/schema.zod.js').then(m => m.TooltipPropsSchema);
    case 'ToolbarContextProps': return import('../components/ToolbarContextProps/schema.zod.js').then(m => m.ToolbarContextPropsSchema);
    case 'ToolbarContentContextProps': return import('../components/ToolbarContentContextProps/schema.zod.js').then(m => m.ToolbarContentContextPropsSchema);
    case 'ToolbarToggleGroup': return import('../components/ToolbarToggleGroup/schema.zod.js').then(m => m.ToolbarToggleGroupSchema);
    case 'ToolbarToggleGroupProps': return import('../components/ToolbarToggleGroupProps/schema.zod.js').then(m => m.ToolbarToggleGroupPropsSchema);
    case 'ToolbarLabelGroupContent': return import('../components/ToolbarLabelGroupContent/schema.zod.js').then(m => m.ToolbarLabelGroupContentSchema);
    case 'ToolbarItem': return import('../components/ToolbarItem/schema.zod.js').then(m => m.ToolbarItemSchema);
    case 'ToolbarItemProps': return import('../components/ToolbarItemProps/schema.zod.js').then(m => m.ToolbarItemPropsSchema);
    case 'ToolbarGroup': return import('../components/ToolbarGroup/schema.zod.js').then(m => m.ToolbarGroupSchema);
    case 'ToolbarGroupProps': return import('../components/ToolbarGroupProps/schema.zod.js').then(m => m.ToolbarGroupPropsSchema);
    case 'ToolbarFilter': return import('../components/ToolbarFilter/schema.zod.js').then(m => m.ToolbarFilterSchema);
    case 'ToolbarLabelGroup': return import('../components/ToolbarLabelGroup/schema.zod.js').then(m => m.ToolbarLabelGroupSchema);
    case 'ToolbarLabel': return import('../components/ToolbarLabel/schema.zod.js').then(m => m.ToolbarLabelSchema);
    case 'ToolbarFilterProps': return import('../components/ToolbarFilterProps/schema.zod.js').then(m => m.ToolbarFilterPropsSchema);
    case 'ToolbarFilterState': return import('../components/ToolbarFilterState/schema.zod.js').then(m => m.ToolbarFilterStateSchema);
    case 'ToolbarExpandableContent': return import('../components/ToolbarExpandableContent/schema.zod.js').then(m => m.ToolbarExpandableContentSchema);
    case 'ToolbarContent': return import('../components/ToolbarContent/schema.zod.js').then(m => m.ToolbarContentSchema);
    case 'ToolbarContentProps': return import('../components/ToolbarContentProps/schema.zod.js').then(m => m.ToolbarContentPropsSchema);
    case 'Toolbar': return import('../components/Toolbar/schema.zod.js').then(m => m.ToolbarSchema);
    ...
    case 'TimestampTooltip': return import('../components/TimestampTooltip/schema.zod.js').then(m => m.TimestampTooltipSchema);
    case 'TimePicker': return import('../components/TimePicker/schema.zod.js').then(m => m.TimePickerSchema);
    case 'TimePickerProps': return import('../components/TimePickerProps/schema.zod.js').then(m => m.TimePickerPropsSchema);
    case 'TimePickerState': return import('../components/TimePickerState/schema.zod.js').then(m => m.TimePickerStateSchema);
    case 'TextInputGroupMain': return import('../components/TextInputGroupMain/schema.zod.js').then(m => m.TextInputGroupMainSchema);
    case 'TextInputGroupMainProps': return import('../components/TextInputGroupMainProps/schema.zod.js').then(m => m.TextInputGroupMainPropsSchema);
    case 'TextInputGroupIcon': return import('../components/TextInputGroupIcon/schema.zod.js').then(m => m.TextInputGroupIconSchema);
    case 'TextInputGroup': return import('../components/TextInputGroup/schema.zod.js').then(m => m.TextInputGroupSchema);
    ...
    case 'HorizontalOverflowObject': return import('../components/HorizontalOverflowObject/schema.zod.js').then(m => m.HorizontalOverflowObjectSchema);
    case 'TabsProps': return import('../components/TabsProps/schema.zod.js').then(m => m.TabsPropsSchema);
    case 'TabsState': return import('../components/TabsState/schema.zod.js').then(m => m.TabsStateSchema);
    case 'TabContentBody': return import('../components/TabContentBody/schema.zod.js').then(m => m.TabContentBodySchema);
    case 'TabContent': return import('../components/TabContent/schema.zod.js').then(m => m.TabContentSchema);
    case 'TabContentProps': return import('../components/TabContentProps/schema.zod.js').then(m => m.TabContentPropsSchema);
    case 'TabButton': return import('../components/TabButton/schema.zod.js').then(m => m.TabButtonSchema);
    case 'TabButtonProps': return import('../components/TabButtonProps/schema.zod.js').then(m => m.TabButtonPropsSchema);
    case 'TabAction': return import('../components/TabAction/schema.zod.js').then(m => m.TabActionSchema);
    case 'TabActionProps': return import('../components/TabActionProps/schema.zod.js').then(m => m.TabActionPropsSchema);
    case 'Tab': return import('../components/Tab/schema.zod.js').then(m => m.TabSchema);
    case 'TabProps': return import('../components/TabProps/schema.zod.js').then(m => m.TabPropsSchema);
    case 'OverflowTab': return import('../components/OverflowTab/schema.zod.js').then(m => m.OverflowTabSchema);
    case 'Switch': return import('../components/Switch/schema.zod.js').then(m => m.SwitchSchema);
    ...
    case 'SimpleListProps': return import('../components/SimpleListProps/schema.zod.js').then(m => m.SimpleListPropsSchema);
    case 'SimpleListState': return import('../components/SimpleListState/schema.zod.js').then(m => m.SimpleListStateSchema);
    case 'SimpleListContextProps': return import('../components/SimpleListContextProps/schema.zod.js').then(m => m.SimpleListContextPropsSchema);
    case 'SidebarPanel': return import('../components/SidebarPanel/schema.zod.js').then(m => m.SidebarPanelSchema);
    ...
    case 'ProgressStepperProps': return import('../components/ProgressStepperProps/schema.zod.js').then(m => m.ProgressStepperPropsSchema);
    case 'ProgressStep': return import('../components/ProgressStep/schema.zod.js').then(m => m.ProgressStepSchema);
    case 'ProgressStepProps': return import('../components/ProgressStepProps/schema.zod.js').then(m => m.ProgressStepPropsSchema);
    case 'ProgressContainer': return import('../components/ProgressContainer/schema.zod.js').then(m => m.ProgressContainerSchema);
    case 'ProgressContainerProps': return import('../components/ProgressContainerProps/schema.zod.js').then(m => m.ProgressContainerPropsSchema);
    case 'ProgressBar': return import('../components/ProgressBar/schema.zod.js').then(m => m.ProgressBarSchema);
    ...
    case 'PaginationNavigation': return import('../components/PaginationNavigation/schema.zod.js').then(m => m.PaginationNavigationSchema);
    case 'PaginationNavigationProps': return import('../components/PaginationNavigationProps/schema.zod.js').then(m => m.PaginationNavigationPropsSchema);
    case 'PaginationNavigationState': return import('../components/PaginationNavigationState/schema.zod.js').then(m => m.PaginationNavigationStateSchema);
    case 'Pagination': return import('../components/Pagination/schema.zod.js').then(m => m.PaginationSchema);
    ...
    case 'PageSidebar': return import('../components/PageSidebar/schema.zod.js').then(m => m.PageSidebarSchema);
    case 'PageSidebarContextProps': return import('../components/PageSidebarContextProps/schema.zod.js').then(m => m.PageSidebarContextPropsSchema);
    case 'PageSection': return import('../components/PageSection/schema.zod.js').then(m => m.PageSectionSchema);
    case 'PageSectionProps': return import('../components/PageSectionProps/schema.zod.js').then(m => m.PageSectionPropsSchema);
    case 'PageGroup': return import('../components/PageGroup/schema.zod.js').then(m => m.PageGroupSchema);
    case 'PageGroupProps': return import('../components/PageGroupProps/schema.zod.js').then(m => m.PageGroupPropsSchema);
    case 'PageContextProps': return import('../components/PageContextProps/schema.zod.js').then(m => m.PageContextPropsSchema);
    case 'PageBreadcrumb': return import('../components/PageBreadcrumb/schema.zod.js').then(m => m.PageBreadcrumbSchema);
    ...
    case 'NavItemProps': return import('../components/NavItemProps/schema.zod.js').then(m => m.NavItemPropsSchema);
    case 'NavGroup': return import('../components/NavGroup/schema.zod.js').then(m => m.NavGroupSchema);
    case 'NavExpandable': return import('../components/NavExpandable/schema.zod.js').then(m => m.NavExpandableSchema);
    case 'NavExpandableProps': return import('../components/NavExpandableProps/schema.zod.js').then(m => m.NavExpandablePropsSchema);
    case 'NavExpandableState': return import('../components/NavExpandableState/schema.zod.js').then(m => m.NavExpandableStateSchema);
    ...
    case 'ModalBoxTitle': return import('../components/ModalBoxTitle/schema.zod.js').then(m => m.ModalBoxTitleSchema);
    case 'ModalBoxCloseButton': return import('../components/ModalBoxCloseButton/schema.zod.js').then(m => m.ModalBoxCloseButtonSchema);
    case 'ModalBoxCloseButtonProps': return import('../components/ModalBoxCloseButtonProps/schema.zod.js').then(m => m.ModalBoxCloseButtonPropsSchema);
    case 'ModalBox': return import('../components/ModalBox/schema.zod.js').then(m => m.ModalBoxSchema);
    case 'ModalBoxProps': return import('../components/ModalBoxProps/schema.zod.js').then(m => m.ModalBoxPropsSchema);
    case 'ModalBody': return import('../components/ModalBody/schema.zod.js').then(m => m.ModalBodySchema);
    ...
    case 'LoginHeader': return import('../components/LoginHeader/schema.zod.js').then(m => m.LoginHeaderSchema);
    ...
    case 'FormGroupLabelHelpProps': return import('../components/FormGroupLabelHelpProps/schema.zod.js').then(m => m.FormGroupLabelHelpPropsSchema);
    case 'FormGroup': return import('../components/FormGroup/schema.zod.js').then(m => m.FormGroupSchema);
    case 'FormFieldGroupToggle': return import('../components/FormFieldGroupToggle/schema.zod.js').then(m => m.FormFieldGroupToggleSchema);
    case 'FormFieldGroupToggleProps': return import('../components/FormFieldGroupToggleProps/schema.zod.js').then(m => m.FormFieldGroupTogglePropsSchema);
    case 'FormFieldGroupHeader': return import('../components/FormFieldGroupHeader/schema.zod.js').then(m => m.FormFieldGroupHeaderSchema);
    case 'FormFieldGroupHeaderTitleTextObject': return import('../components/FormFieldGroupHeaderTitleTextObject/schema.zod.js').then(m => m.FormFieldGroupHeaderTitleTextObjectSchema);
    case 'FormFieldGroupExpandable': return import('../components/FormFieldGroupExpandable/schema.zod.js').then(m => m.FormFieldGroupExpandableSchema);
    case 'FormFieldGroup': return import('../components/FormFieldGroup/schema.zod.js').then(m => m.FormFieldGroupSchema);
    case 'FormContextProps': return import('../components/FormContextProps/schema.zod.js').then(m => m.FormContextPropsSchema);
    ...
    case 'DualListSelectorTreeItemData': return import('../components/DualListSelectorTreeItemData/schema.zod.js').then(m => m.DualListSelectorTreeItemDataSchema);
    case 'DualListSelectorTreeProps': return import('../components/DualListSelectorTreeProps/schema.zod.js').then(m => m.DualListSelectorTreePropsSchema);
    case 'DualListSelectorPane': return import('../components/DualListSelectorPane/schema.zod.js').then(m => m.DualListSelectorPaneSchema);
    case 'DualListSelectorListWrapperProps': return import('../components/DualListSelectorListWrapperProps/schema.zod.js').then(m => m.DualListSelectorListWrapperPropsSchema);
    case 'DualListSelectorListItemProps': return import('../components/DualListSelectorListItemProps/schema.zod.js').then(m => m.DualListSelectorListItemPropsSchema);
    case 'DualListSelectorListProps': return import('../components/DualListSelectorListProps/schema.zod.js').then(m => m.DualListSelectorListPropsSchema);
    ...
    case 'DrawerPanelContentProps': return import('../components/DrawerPanelContentProps/schema.zod.js').then(m => m.DrawerPanelContentPropsSchema);
    case 'DrawerPanelBody': return import('../components/DrawerPanelBody/schema.zod.js').then(m => m.DrawerPanelBodySchema);
    case 'DrawerContent': return import('../components/DrawerContent/schema.zod.js').then(m => m.DrawerContentSchema);
    case 'DrawerCloseButton': return import('../components/DrawerCloseButton/schema.zod.js').then(m => m.DrawerCloseButtonSchema);
    ...
    case 'DataListItemRow': return import('../components/DataListItemRow/schema.zod.js').then(m => m.DataListItemRowSchema);
    case 'DataListItemCells': return import('../components/DataListItemCells/schema.zod.js').then(m => m.DataListItemCellsSchema);
    case 'DataListItem': return import('../components/DataListItem/schema.zod.js').then(m => m.DataListItemSchema);
    case 'DataListItemProps': return import('../components/DataListItemProps/schema.zod.js').then(m => m.DataListItemPropsSchema);
    case 'DataListItemChildProps': return import('../components/DataListItemChildProps/schema.zod.js').then(m => m.DataListItemChildPropsSchema);
    case 'DataListDragButton': return import('../components/DataListDragButton/schema.zod.js').then(m => m.DataListDragButtonSchema);
    case 'DataListContent': return import('../components/DataListContent/schema.zod.js').then(m => m.DataListContentSchema);
    case 'DataListContentProps': return import('../components/DataListContentProps/schema.zod.js').then(m => m.DataListContentPropsSchema);
    case 'DataListCheck': return import('../components/DataListCheck/schema.zod.js').then(m => m.DataListCheckSchema);
    case 'DataListCheckProps': return import('../components/DataListCheckProps/schema.zod.js').then(m => m.DataListCheckPropsSchema);
    case 'DataListCell': return import('../components/DataListCell/schema.zod.js').then(m => m.DataListCellSchema);
    case 'DataListAction': return import('../components/DataListAction/schema.zod.js').then(m => m.DataListActionSchema);
    ...
    case 'ClipboardCopyButtonProps': return import('../components/ClipboardCopyButtonProps/schema.zod.js').then(m => m.ClipboardCopyButtonPropsSchema);
    ...
    case 'CardHeaderSelectableActionsObject': return import('../components/CardHeaderSelectableActionsObject/schema.zod.js').then(m => m.CardHeaderSelectableActionsObjectSchema);
    case 'CardBody': return import('../components/CardBody/schema.zod.js').then(m => m.CardBodySchema);
    case 'CardBodyProps': return import('../components/CardBodyProps/schema.zod.js').then(m => m.CardBodyPropsSchema);
    case 'CardActions': return import('../components/CardActions/schema.zod.js').then(m => m.CardActionsSchema);
    ...
    case 'AccordionProps': return import('../components/AccordionProps/schema.zod.js').then(m => m.AccordionPropsSchema);
    case 'AboutModalBoxHeader': return import('../components/AboutModalBoxHeader/schema.zod.js').then(m => m.AboutModalBoxHeaderSchema);
    case 'AboutModalBoxContent': return import('../components/AboutModalBoxContent/schema.zod.js').then(m => m.AboutModalBoxContentSchema);
    case 'AboutModalBoxCloseButton': return import('../components/AboutModalBoxCloseButton/schema.zod.js').then(m => m.AboutModalBoxCloseButtonSchema);
    case 'AboutModalBoxCloseButtonProps': return import('../components/AboutModalBoxCloseButtonProps/schema.zod.js').then(m => m.AboutModalBoxCloseButtonPropsSchema);
    ...
    case 'WizardNavItemProps-deprecated': return import('../components/WizardNavItemProps-deprecated/schema.zod.js').then(m => m.WizardNavItemProps-deprecatedSchema);
    case 'WizardNav-deprecated': return import('../components/WizardNav-deprecated/schema.zod.js').then(m => m.WizardNav-deprecatedSchema);
    case 'WizardNavProps-deprecated': return import('../components/WizardNavProps-deprecated/schema.zod.js').then(m => m.WizardNavProps-deprecatedSchema);
    case 'WizardHeader-deprecated': return import('../components/WizardHeader-deprecated/schema.zod.js').then(m => m.WizardHeader-deprecatedSchema);
    case 'WizardFooterInternal-deprecated': return import('../components/WizardFooterInternal-deprecated/schema.zod.js').then(m => m.WizardFooterInternal-deprecatedSchema);
    case 'WizardFooter-deprecated': return import('../components/WizardFooter-deprecated/schema.zod.js').then(m => m.WizardFooter-deprecatedSchema);
    case 'WizardDrawerWrapperProps-deprecated': return import('../components/WizardDrawerWrapperProps-deprecated/schema.zod.js').then(m => m.WizardDrawerWrapperProps-deprecatedSchema);
    case 'WizardBody-deprecated': return import('../components/WizardBody-deprecated/schema.zod.js').then(m => m.WizardBody-deprecatedSchema);
    case 'WizardBodyProps-deprecated': return import('../components/WizardBodyProps-deprecated/schema.zod.js').then(m => m.WizardBodyProps-deprecatedSchema);
    case 'Wizard-deprecated': return import('../components/Wizard-deprecated/schema.zod.js').then(m => m.Wizard-deprecatedSchema);
    ...
    case 'DroppableItem-deprecated': return import('../components/DroppableItem-deprecated/schema.zod.js').then(m => m.DroppableItem-deprecatedSchema);
    case 'DragDrop-deprecated': return import('../components/DragDrop-deprecated/schema.zod.js').then(m => m.DragDrop-deprecatedSchema);
    case 'DraggableItemPosition-deprecated': return import('../components/DraggableItemPosition-deprecated/schema.zod.js').then(m => m.DraggableItemPosition-deprecatedSchema);
    case 'ChipGroup-deprecated': return import('../components/ChipGroup-deprecated/schema.zod.js').then(m => m.ChipGroup-deprecatedSchema);
    case 'ChipGroupProps-deprecated': return import('../components/ChipGroupProps-deprecated/schema.zod.js').then(m => m.ChipGroupProps-deprecatedSchema);
    case 'Chip-deprecated': return import('../components/Chip-deprecated/schema.zod.js').then(m => m.Chip-deprecatedSchema);
    case 'ChipProps-deprecated': return import('../components/ChipProps-deprecated/schema.zod.js').then(m => m.ChipProps-deprecatedSchema);
